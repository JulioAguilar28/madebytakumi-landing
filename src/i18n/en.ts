export const en = {
  ...
  cta: {
    ...
    body: "Tell me what you want to build and I’ll reply with a clear path forward.",
    name: "Name",
    ...
    note: "You can also message me directly on WhatsApp if you prefer a faster conversation.",
  },
  footer: {
